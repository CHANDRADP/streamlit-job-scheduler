...
class SchedulerConfig:
    ...
    def __init__(self, schedule_type:ScheduleType = ScheduleType.CRONJOB, schedule=None, title="🕒 Schedule a Job", display_only: ScheduleType = ScheduleType.CRONJOB, show_schedule_type: bool = False):
        """
        ...
        """
        self.title = title
        self.schedule_type = schedule_type.value
